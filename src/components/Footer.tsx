      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="https://drive.google.com/file/d/1GJRLD1LiBNI0-kN9IHBKNRToOCdYjtNw/view?usp=sharing" className="font-open-sans text-sm text-white/80 hover:text-accent transition-colors duration-300"target='_blank'>
                  Code of Conduct
                </Link>
              </li>
              <li>
                <Link href="https://drive.google.com/file/d/1lv3-vPzostvvHCLLhooXRIl4pd5lEXfw/view?usp=sharing" className="font-open-sans text-sm text-white/80 hover:text-accent transition-colors duration-300"target='_blank'>
                  Attendance Policy
                </Link>
              </li>
              <li>
                <Link href="https://drive.google.com/file/d/1yZnQDkKua2D1oWQBtHU_xRq8auXrKtGu/view?usp=sharing" className="font-open-sans text-sm text-white/80 hover:text-accent transition-colors duration-300"target='_blank'>
                  Scholarship Policy
                </Link>
              </li>
              <li>
                <Link href="https://drive.google.com/file/d/1wxkUKD_MFo22ZPpxEDy8CgKdTuHN16wP/view?usp=sharing" className="font-open-sans text-sm text-white/80 hover:text-accent transition-colors duration-300"target='_blank'>
                  Examination Policy
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="https://drive.google.com/file/d/1TN_2XOzlgvgFMcewR_LnYdMRfuY0KGOv/view?usp=sharing" className="font-open-sans text-sm text-white/80 hover:text-accent transition-colors duration-300"target='_blank'>
                  Library Policy
                </Link>
              </li>
              <li>
                <Link href="https://drive.google.com/file/d/14XRHr6I1h8oHipR9tbdXJdahoN21Almb/view?usp=sharing" className="font-open-sans text-sm text-white/80 hover:text-accent transition-colors duration-300"target='_blank'>
                  Klib Rules
                </Link>
              </li>
              <li>
                <Link href="https://drive.google.com/file/d/1rwl0LJtZlq9W_LsKuJ6tmKDbA8YyiHle/view?usp=sharing" className="font-open-sans text-sm text-white/80 hover:text-accent transition-colors duration-300"target='_blank'>
                  Sexual Harassment Policy
                </Link>
              </li>
              <li>
                <Link href="https://drive.google.com/file/d/1K8Z4nVVk6_Py8ja_uC3gmYEtNP9owuYM/view?usp=sharing" className="font-open-sans text-sm text-white/80 hover:text-accent transition-colors duration-300"target='_blank'>
                  Anti-Ragging Policy
                </Link>
              </li>
              <li>
                <Link href="https://drive.google.com/file/d/1dSdkRn0HPCpyjITGtBvvrYjrNe1icvEj/view?usp=sharing" className="font-open-sans text-sm text-white/80 hover:text-accent transition-colors duration-300"target='_blank'>
                  Social Media Policy
                </Link>
              </li>
              <li>
                <Link href="https://drive.google.com/file/d/1mf76AtfWKcxtYJJIjedBTXR5XHreT49L/view?usp=sharing" className="font-open-sans text-sm text-white/80 hover:text-accent transition-colors duration-300" target='_blank'>
